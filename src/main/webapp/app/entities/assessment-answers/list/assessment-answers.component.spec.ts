...
describe('AssessmentAnswers Management Component', () => {
  let comp: AssessmentAnswersComponent;
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [
        RouterTestingModule.withRoutes([{ path: 'assessment-answers', component: AssessmentAnswersComponent }]),
      ...
      .overrideTemplate(AssessmentAnswersComponent, '')
      .compileComponents();
